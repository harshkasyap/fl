...
def train(num_clients, num_rounds, train_loader, test_loader, backdoor_test_loader, losses_train, losses_test, 
          ...
          source,target,euclid_dist_roundwise, autoencoder_test_data_roundwise, shap_data_roundwise):
...
def run(attackers_id, source_label, poisoned_label,sample_to_poison,client_data, test_data, backdoor_test_data):
  ...
  train(participated_clients,num_rounds,train_loader,test_loader,backdoor_test_loader, losses_train_p,losses_test_p,
      acc_train_p,acc_test_p,backdoor_acc_test_p,misclassification_rates_p,attack_success_rates_p,communication_rounds_p,clients_local_updates_p,global_update_p,source_label,poisoned_label,euclid_dist_roundwise_p,autoencoder_test_data_roundwise_p,shap_data_p)
...
print("Running  Federated Learning with 18 attacker")
local_data_fl = copy.copy(clients_data)
attackers = [1,2,3,5,7,9,11,12,13,15,17,19,20,21,23,25,27,29]
poisoned_sample, attack_success_rate, misclassification_rates,acc_test, backdoor_acc_test, global_updates, client_local_updates, rounds ,euclid_dists ,autoencoder_results, shap_data = run(attackers,6,2,500,local_data_fl, test_data_1, backdoor_test_data)
...
with open('accuracy_fashion_attack_18','wb') as fp:
  pickle.dump(global_accuracy_list,fp)
with open('backdoor_accuracy_fashion_attack_18','wb') as fp:
  pickle.dump(global_backdoor_accuracy_list,fp)
#with open('euclid_dist_fashion_attack_thirty','wb') as fp:
#  pickle.dump(global_euclid_data,fp)
with open('comm_rounds_fashion_attack_18','wb') as fp:
  pickle.dump(global_communication_rounds,fp)
#with open('autoencoder_result_fashion_attack_six','wb') as fp:
#  pickle.dump(global_ae_data,fp)
#with open('shap_data_fashion_attack_six','wb') as fp:

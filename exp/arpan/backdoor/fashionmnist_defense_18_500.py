...
print("Running  Federated Learning with 18 attacker and defense")
...
with open('accuracy_fashion_defense_18','wb') as fp:
  pickle.dump(global_accuracy_list,fp)
with open('backdoor_accuracy_fashion_defense_18','wb') as fp:
  pickle.dump(global_backdoor_accuracy_list,fp)
with open('comm_rounds_fashion_defense_18','wb') as fp:

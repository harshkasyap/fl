...
print("Running  Federated Learning with 21 attacker")
...
with open('accuracy_fashion_attack_21','wb') as fp:
  pickle.dump(global_accuracy_list,fp)
with open('backdoor_accuracy_fashion_attack_21','wb') as fp:
...
with open('comm_rounds_fashion_attack_21','wb') as fp:

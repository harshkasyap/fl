...
def run(attackers_id, source_label, poisoned_label,sample_to_poison,client_data, test_data, backdoor_test_data,threshold,defense_flag):
  ...
  train(participated_clients,num_rounds,train_loader,test_loader,backdoor_test_loader, 
    losses_train_p,losses_test_p,acc_train_p,acc_test_p,backdoor_acc_test_p,misclassification_rates_p,
    targeted_misclassification_rates_p,attack_success_rates_p,communication_rounds_p,clients_local_updates_p,
    global_update_p,source_label,poisoned_label,euclid_dist_roundwise_p,autoencoder_test_data_roundwise_p,
    shap_data_p,threshold,defense_flag)
...
threshold_list = [1.5,2.0,2.5,3.0]
for thshld in threshold_list:
  ...
  poisoned_sample, attack_success_rate, misclassification_rates,target_misclassification_rates,acc_test, backdoor_acc_test, global_updates, client_local_updates, rounds ,euclid_dists ,autoencoder_results, shap_data = run(attackers,6,2,120,local_data_fl, test_data_1, backdoor_test_data,thshld,True)
...
local_data_fl = copy.copy(clients_data)
attackers = [1,2,3,4,5,6,7,9,13,15,16,17,19,20,21,23,25,27]
poisoned_sample, attack_success_rate, misclassification_rates,target_misclassification_rates,acc_test, backdoor_acc_test, global_updates, client_local_updates, rounds ,euclid_dists ,autoencoder_results, shap_data = run(attackers,6,2,120,local_data_fl, test_data_1, backdoor_test_data,thshld,False)
global_accuracy_list.append(acc_test)
global_backdoor_accuracy_list.append(backdoor_acc_test)
global_communication_rounds.append(rounds)
global_poison_sample_list.append(poisoned_sample)
...
with open('accuracy_mnist_lfa_threshold_18','wb') as fp:
  pickle.dump(global_accuracy_list,fp)
with open('comm_rounds_mnist_lfa_threshold_18','wb') as fp:
  pickle.dump(global_communication_rounds,fp)
with open('mcr_mnist_lfa_threshold_18','wb') as fp:
  pickle.dump(global_misclassification_rates,fp)
with open('tmcr_mnist_lfa_threshold_18','wb') as fp:
  pickle.dump(global_target_misclassification_rates,fp)
with open('asr_mnist_lfa_threshold_18','wb') as fp:

...
Original file is located at
    https://colab.research.google.com/drive/1CW2Rsa3-P1Xb4PCVbO2xAxBAspgQYKL8
"""
...
def train(num_clients, num_rounds, train_loader, test_loader, backdoor_test_loader, losses_train, losses_test, 
          ...
          source,target,euclid_dist_roundwise, autoencoder_test_data_roundwise):
...
def run(attackers_id, source_label, poisoned_label,sample_to_poison,client_data, test_data, backdoor_test_data):
  ...
  #for id in attackers_id:
  #  total_poisoned_samples += insert_trojan(client_data,id,2,250)
  ...
  train(participated_clients,num_rounds,train_loader,test_loader,backdoor_test_loader, losses_train_p,losses_test_p,
      acc_train_p,acc_test_p,backdoor_acc_test_p,misclassification_rates_p,attack_success_rates_p,communication_rounds_p,clients_local_updates_p,global_update_p,source_label,poisoned_label,euclid_dist_roundwise_p,autoencoder_test_data_roundwise_p)

  print("accuracy",acc_test_p[len(acc_test_p)-1])
  return total_poisoned_samples, attack_success_rates_p, misclassification_rates_p ,acc_test_p, backdoor_acc_test_p, global_update_p, clients_local_updates_p,  communication_rounds_p, euclid_dist_roundwise_p, autoencoder_test_data_roundwise_p
...
backdoor_test_data = insert_trojan_testing(test_data_2)

#plt.imshow(backdoor_test_data[6][0].reshape(28,28))



#shap_background, shap_test = torch.utils.data.random_split(test_data_2, [4000, 5000])

#getcount_label(clients_data[2])
...
attackers = []
poisoned_sample, attack_success_rate, misclassification_rates,acc_test, backdoor_acc_test, global_updates, client_local_updates, rounds ,euclid_dists , autoencoder_results = run(attackers,6,2,-1,local_data_fl, test_data_1,backdoor_test_data)
...
print("Running  Federated Learning with 2 attacker")
local_data_fl = copy.copy(clients_data)
attackers = [2,7]
poisoned_sample, attack_success_rate, misclassification_rates,acc_test, backdoor_acc_test, global_updates, client_local_updates, rounds ,euclid_dists ,autoencoder_results = run(attackers,6,2,1200,local_data_fl, test_data_1, backdoor_test_data)
global_accuracy_list.append(acc_test)
global_backdoor_accuracy_list.append(backdoor_acc_test)
global_communication_rounds.append(rounds)
global_poison_sample_list.append(poisoned_sample)
...
print("Running  Federated Learning with 3 attacker")
local_data_fl = copy.copy(clients_data)
attackers = [2,7,15]
poisoned_sample, attack_success_rate, misclassification_rates,acc_test, backdoor_acc_test, global_updates, client_local_updates, rounds ,euclid_dists ,autoencoder_results = run(attackers,6,2,800,local_data_fl, test_data_1, backdoor_test_data)
global_accuracy_list.append(acc_test)
global_backdoor_accuracy_list.append(backdoor_acc_test)
global_communication_rounds.append(rounds)
global_poison_sample_list.append(poisoned_sample)
...
print("Running  Federated Learning with 4 attacker")
local_data_fl = copy.copy(clients_data)
attackers = [2,7,15,20]
poisoned_sample, attack_success_rate, misclassification_rates,acc_test, backdoor_acc_test, global_updates, client_local_updates, rounds ,euclid_dists ,autoencoder_results = run(attackers,6,2,600,local_data_fl, test_data_1, backdoor_test_data)
global_accuracy_list.append(acc_test)
global_backdoor_accuracy_list.append(backdoor_acc_test)
global_communication_rounds.append(rounds)
global_poison_sample_list.append(poisoned_sample)
...
with open('euclid_dist','wb') as fp:
  pickle.dump(global_euclid_data,fp)
with open('comm_rounds','wb') as fp:
  pickle.dump(global_communication_rounds,fp)
with open('autoencoder_result','wb') as fp:
...
with open('backdoor_acc','wb') as fp:
